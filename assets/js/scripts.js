...
var vm = new Vue({
	...
	methods: {
		...
		preview_chart: function () {
			...
			vm.saved_canvas_content = $.extend({}, vm.canvas_content);
			vm.saved_canvas_content.options.responsive = false;
			console.log(vm.saved_canvas_content);

			// vm.saved_canvas_content.options.responsive = false;

    		var cache = [];
			vm.chart_data = JSON.stringify(vm.saved_canvas_content, function(key, value) {
